...
const GraphExploration = () => {
    ...
    const handleDrop = (event) => {
        ...
        if (draggedFilter === filterName) {
            ...
            axios
                .post(`${apiUrl}/graphic-data`, data, { headers: headers })
    ...
    // Evitar el comportamiento predeterminado del drop (evitar que se abra el contenido si se suelta fuera del área de drop)
